...
def register_commodity_tools(mcp: FastMCP):
    ...
    async def get_commodity_overview(
        ...
        CONCEPT: 聚合黄金/白银/原油三大商品, 提供跨资产联动快照.
        DIFFERENTIATION: 商品全景聚合; 单品种深度看 get_gold_price / get_silver_price / get_crude_oil_price.
        next_recommended_tools: get_gold_price -> get_silver_price -> get_crude_oil_price
        ...
        try:
            ...
            parts: list[str] = []
            for name, label in [("gold", "黄金"), ("silver", "白银"), ("crude_oil", "原油")]:
