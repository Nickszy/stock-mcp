# src/server/domain/field_dictionaries.py
"""Authoritative field dictionaries for A-share financial data.

Source: Tushare Pro official documentation (https://tushare.pro/document/2)
- doc_id=33 (Income Statement)
- doc_id=36 (Balance Sheet)
- doc_id=44 (Cash Flow Statement)
- doc_id=79 (Financial Indicators)

All mappings are verbatim from Tushare docs. Do NOT guess or modify.
"""

# =====================================================================
# Coded-value mappings (numeric/alpha codes → human-readable Chinese)
# =====================================================================
...
UPDATE_FLAG: dict[str, str] = {
    "1": "最新",
}

END_TYPE: dict[str, str] = {
    "1": "年报",
    "2": "中报",
    "3": "一季报",
    "4": "三季报",
...
# end_date (报告期) suffix → human-readable period name
END_DATE_PERIOD: dict[str, str] = {
    "1231": "年报",
    "0331": "一季报",
    "0630": "中报",
    "0930": "三季报",
...
# =====================================================================
# Field name → Chinese label translations
# =====================================================================

# -- Common fields shared across all financial statements ----------
...
# -- Income Statement (利润表) doc_id=33 ----------------------------
...
# -- Balance Sheet (资产负债表) doc_id=36 ---------------------------
BALANCE_SHEET_FIELDS: dict[str, str] = {
    "total_share": "期末总股本",
    "cap_rese": "资本公积金",
...
# -- Cash Flow Statement (现金流量表) doc_id=44 --------------------
...
# -- Financial Indicators (财务指标数据) doc_id=79 ------------------
FINANCIAL_INDICATOR_FIELDS: dict[str, str] = {
    "eps": "基本每股收益",
    "dt_eps": "稀释每股收益",
...
# =====================================================================
# Composite lookup: all fields unioned for convenience
# =====================================================================

ALL_FINANCIAL_FIELDS: dict[str, str] = {}
for _d in (COMMON_FIELDS, INCOME_FIELDS, BALANCE_SHEET_FIELDS,
           CASH_FLOW_FIELDS, FINANCIAL_INDICATOR_FIELDS):
    ALL_FINANCIAL_FIELDS.update(_d)

# All coded-value lookups
...
# Fields that have coded values requiring translation
CODED_FIELD_NAMES: set[str] = set(CODED_FIELDS.keys())

# Date-format fields that need formatting from YYYYMMDD → YYYY-MM-DD
DATE_FIELDS: set[str] = {"ann_date", "f_ann_date", "end_date"}
